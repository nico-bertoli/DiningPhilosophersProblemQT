This project explores the implementation of the classic Dining Philosophers Problem, the goal was to experiment with the QT framework and multithreading in C++.
